...
namespace ShopEase.Backend.PassportService.Persistence.Migrations
{
    ...
    [Migration("20240323062055_add-outbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopEase.Backend.Common.Messaging.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("OutboxMessage", "Passport");
                });

            modelBuilder.Entity("ShopEase.Backend.Common.Messaging.Outbox.OutboxMessageConsumer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OutboxMessageConsumer", "Passport");
                });

            modelBuilder.Entity("ShopEase.Backend.PassportService.Core.Aggregate.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopEase.Backend.PassportService.Core.Entities.Address", b =>
                {
                    b.HasOne("ShopEase.Backend.PassportService.Core.Aggregate.User", null)
                        .WithMany("Addresses")
